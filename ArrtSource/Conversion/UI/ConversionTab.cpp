...
void ArrtAppWindow::UpdateConversionPane()
{
    ...
    // set advanced options
    {
        ...
        ConversionTab->ScalingSpinbox->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::UniformScaling);
        ConversionTab->ScalingSpinboxL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::UniformScaling);
        ConversionTab->RecenterToOriginCheckbox->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::RecenterToOrigin);
        ConversionTab->RecenterToOriginCheckboxL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::RecenterToOrigin);
        ConversionTab->DefaultSidednessCombo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::MaterialDefaultSidedness);
        ConversionTab->DefaultSidednessComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::MaterialDefaultSidedness);
        ConversionTab->GammaToLinearMaterialCheckbox->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::GammaToLinearMaterial);
        ConversionTab->GammaToLinearMaterialCheckboxL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::GammaToLinearMaterial);
        ConversionTab->GammaToLinearVertexCheckbox->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::GammaToLinearVertex);
        ConversionTab->GammaToLinearVertexCheckboxL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::GammaToLinearVertex);
        ConversionTab->ScenegraphModeCombo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::SceneGraphMode);
        ConversionTab->ScenegraphModeComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::SceneGraphMode);
        ConversionTab->CollisionMeshCheckbox->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::CollisionMesh);
        ConversionTab->CollisionMeshCheckboxL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::CollisionMesh);
        ConversionTab->UnlitMaterialsCheckbox->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::UnlitMaterials);
        ConversionTab->UnlitMaterialsCheckboxL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::UnlitMaterials);
        ConversionTab->FbxAssumeMetallicCheckbox->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::FbxAssumeMetallic);
        ConversionTab->FbxAssumeMetallicCheckboxL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::FbxAssumeMetallic);
        ConversionTab->DeduplicateMaterialsCheckbox->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::DeduplicateMaterials);
        ConversionTab->DeduplicateMaterialsCheckboxL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::DeduplicateMaterials);
        ConversionTab->Axis0Combo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::AxisMapping);
        ConversionTab->Axis0ComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::AxisMapping);
        ConversionTab->Axis1Combo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::AxisMapping);
        ConversionTab->Axis1ComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::AxisMapping);
        ConversionTab->Axis2Combo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::AxisMapping);
        ConversionTab->Axis2ComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::AxisMapping);
        ConversionTab->VertexPositionCombo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexPositionFormat);
        ConversionTab->VertexPositionComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexPositionFormat);
        ConversionTab->VertexColor0Combo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexColor0Format);
        ConversionTab->VertexColor0ComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexColor0Format);
        ConversionTab->VertexColor1Combo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexColor1Format);
        ConversionTab->VertexColor1ComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexColor1Format);
        ConversionTab->VertexNormalCombo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexNormalFormat);
        ConversionTab->VertexNormalComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexNormalFormat);
        ConversionTab->VertexTangentCombo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexTangentFormat);
        ConversionTab->VertexTangentComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexTangentFormat);
        ConversionTab->VertexBitangentCombo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexBinormalFormat);
        ConversionTab->VertexBitangentComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexBinormalFormat);
        ConversionTab->TexCoord0Combo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexTexCoord0Format);
        ConversionTab->TexCoord0ComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexTexCoord0Format);
        ConversionTab->TexCoord1Combo->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexTexCoord1Format);
        ConversionTab->TexCoord1ComboL->setVisible(conv.m_displayOptions & (uint64_t)ConversionOption::VertexTexCoord1Format);
    }
